...
public class Historical_report_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historical_report_);
        ...
        listView = (ListView) findViewById(R.id.historical_report_list);
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    if (report.size() == 0){
                        ...
                        for (int i = 0; i < report.size(); i++) {
                            if (report.get(i).equals(location)) {
                                add = false;
                            }
                        }
                        if(add == true) {
     ...
     * @param view
     */
    public void goBack_from_historical(View view){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (classes.equals("USER")){
                    startActivity(new Intent(Historical_report_Activity.this, WelcomActivity.class));
                } else if (classes.equals("WORKER")){
                    startActivity(new Intent(Historical_report_Activity.this, Worker_Welcome_Activity.class));
                } else if (classes.equals("MANAGER")){
                    startActivity(new Intent(Historical_report_Activity.this, Manager_Welcome_Activity.class));
                }
            }
