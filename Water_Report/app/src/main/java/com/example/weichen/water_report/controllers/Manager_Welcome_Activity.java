...
public class Manager_Welcome_Activity extends AppCompatActivity {

    private Button logout;
    private Button edit_profile;
    private Button welcom_submit_report;
    private Button view_quality_report;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager__welcome_);
    ...
    public void logout(View view) {
        userAuth.signOut();
        startActivity(new Intent(Manager_Welcome_Activity.this, InitialActivity.class));
    ...
    public void edit_profile(View view) {
        startActivity(new Intent(Manager_Welcome_Activity.this, PersonalProfileActivity.class));
    }
    ...
    public void welcom_submit_report (View view) {
        startActivity(new Intent(Manager_Welcome_Activity.this, SubmitReport.class));
    }
    ...
    public void welcom_submit_purity_report (View view) {
        startActivity(new Intent(Manager_Welcome_Activity.this, Submit_Quality_Reports_Activity.class));
    }
    ...
    public void view_report(View view) {
        startActivity(new Intent(Manager_Welcome_Activity.this, ViewReports.class));
    }
    ...
    public void map_button(View view) {
        startActivity(new Intent(Manager_Welcome_Activity.this, MapsActivity.class));
    }

    /**
     * move to quality report list
     * @param view
     */
